...
let tabsContainerPadding = parseInt(tabsStyles.getPropertyValue("padding-inline"));
...
if(barHandle){
    barHandle.style.width = `${firstTab.offsetWidth + tabsContainerPadding*2}px`;
}

tabs.forEach((el)=>{
    tabsContainerPadding = parseInt(tabsStyles.getPropertyValue("padding-inline"));
    el.addEventListener("click", ()=>{
        ...
        {
            barHandle.style.left = "100%"; barHandle.style.transform = "translateX(-100%)";
